    ...
    <form action="" method="post"  id="type_frm" >
        <table width="100%" id="general-table" align="center">
            <tr>
                ...
                <td>
                    <input type='text' name='admin_name' id="admin_name" value="<?php echo ($adminInfo["admin_name"]); ?>" /> <span style="color:red">*</span>
                </td>
            </tr>
            <tr>
                <td class="label">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
                <td>
                    <input type='password' name='password' id="password" /> <span>如果不输入则使用原来密码</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type='text' name='email' value="<?php echo ($adminInfo["email"]); ?>"  /> <span style="color:red">*</span>
                </td>
            </tr>
            <!--<tr>
            ...
            <tr>
                ...
                <td>
                    <select name="role_id" id="">
                        <?php if(is_array($roleData)): foreach($roleData as $key=>$role): if($role[id] == $adminInfo[role_id]): ?><option value="<?php echo ($role["id"]); ?>" selected><?php echo ($role["role_name"]); ?></option>
                                <?php else: ?>
                                <option value="<?php echo ($role["id"]); ?>"><?php echo ($role["role_name"]); ?></option><?php endif; endforeach; endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
