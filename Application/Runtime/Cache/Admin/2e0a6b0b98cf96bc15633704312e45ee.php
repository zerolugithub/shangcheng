...
<form method="post" action="" name="listForm">
    <div class="list-div" id="listDiv">
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <?php if(is_array($adminData)): foreach($adminData as $k=>$val): ?><tr align="center" class="0">
                    <td width="15%" align="center"><span><?php echo ($val["admin_name"]); ?></span></td>
                    <td width="15%" align="center"><span><?php echo ($val["email"]); ?></span></td>
