                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($Think.cookie.admin_admin_name): ?>value="<?php echo (cookie('admin_admin_name')); ?>"<?php endif; ?>
                            />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($Think.cookie.admin_password): ?>value="<?php echo (cookie('admin_password')); ?>"<?php endif; ?>
                            />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <img src="/index.php/Admin/Login/captcha" onclick="this.src='/index.php/Admin/Login/captcha?'+Math.random()"
