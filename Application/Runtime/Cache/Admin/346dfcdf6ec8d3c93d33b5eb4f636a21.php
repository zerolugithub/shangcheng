                ...
                <tr>
                    ...
                    <td>
                        <select name="cate_id">
                            ...
                            <?php if(is_array($cateData)): foreach($cateData as $key=>$cate): ?><option value="<?php echo ($cate["id"]); ?>"><?php echo (str_repeat('&nbsp;&nbsp;',$cate["level"]*2)); echo ($cate["cate_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <select name="brand_id">
                            <option value="0">请选择...</option>
                            <?php if(is_array($brandData)): $i = 0; $__LIST__ = $brandData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?><option value="<?php echo ($brand["id"]); ?>"><?php echo ($brand["brand_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
